...
public:
    ...
    void run (data_type movies_correlation[m][m], data_type initial_critics[n][m], int IR_output[n], compressed_data_type sparce_movies[m][num_elements], int sparce_movies_index[m][num_elements],int sparce_critics_index[m][n]){
